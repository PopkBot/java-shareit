...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> updateItem(ItemClientDto dto) {
        ...
        return patch("/" + dto.getItemId(), dto.getUserId(), dto.getItemInputDto());
    }
    ...
    public ResponseEntity<Object> searchItem(ItemClientDto dto) {
        ...
        return get("/search?text={text}&from={from}&size={size}", dto.getUserId(), parameters);
    }
    ...
    public ResponseEntity<Object> getAllItemsOfUser(ItemClientDto dto) {
        ...
        return get("?from={from}&size={size}", dto.getUserId(), parameters);
    }
}
